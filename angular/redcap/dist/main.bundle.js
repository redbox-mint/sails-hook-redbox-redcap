...
var BaseService = /** @class */ (function () {
    function BaseService(http, configService) {
        ...
        this.initSubject = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["b" /* Subject */]();
...
var ConfigService = /** @class */ (function () {
    function ConfigService(http) {
        this.http = http;
        this.subjects = {};
        this.subjects['get'] = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["b" /* Subject */]();
        this.initConfig();
    }
...
var DashboardService = /** @class */ (function (_super) {
    ...
    DashboardService.prototype.getAllDraftPlansCanEdit = function () {
        ...
        var start = 0;
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?recordType=rdmp&state=draft&editOnly=true&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment_es6___default()().unix(), this.options)
            .toPromise()
    ...
    DashboardService.prototype.getAllRecordsCanEdit = function (recordType, state) {
        ...
        var rows = this.config.maxTransferRowsPerPage;
        var start = 0;
        var url = this.brandingAndPortalUrl + "/listRecords?recordType=" + recordType + "&editOnly=true&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment_es6___default()().unix();
        if (state != '') {
            url += "&state=" + state;
        }
    ...
    DashboardService.prototype.getActivePlans = function (pageNumber) {
        ...
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?state=active&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment_es6___default()().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
    DashboardService.prototype.getDraftPlans = function (pageNumber) {
        ...
        var rows = 10;
        var start = (pageNumber - 1) * rows;
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?recordType=rdmp&state=draft&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment_es6___default()().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
    DashboardService.prototype.getRecords = function (recordType, state, pageNumber, packageType, sort) {
        ...
        var rows = 10;
        var start = (pageNumber - 1) * rows;
        recordType = (!__WEBPACK_IMPORTED_MODULE_8_lodash__["isEmpty"](recordType) && !__WEBPACK_IMPORTED_MODULE_8_lodash__["isUndefined"](recordType)) ? "recordType=" + recordType : '';
        packageType = (!__WEBPACK_IMPORTED_MODULE_8_lodash__["isEmpty"](packageType) && !__WEBPACK_IMPORTED_MODULE_8_lodash__["isUndefined"](packageType)) ? "packageType=" + packageType : '';
        sort = (!__WEBPACK_IMPORTED_MODULE_8_lodash__["isEmpty"](sort) && !__WEBPACK_IMPORTED_MODULE_8_lodash__["isUndefined"](sort)) ? "&sort=" + sort : '';
        state = (!__WEBPACK_IMPORTED_MODULE_8_lodash__["isEmpty"](state) && !__WEBPACK_IMPORTED_MODULE_8_lodash__["isUndefined"](state)) ? "&state=" + state : '';
        return this.http.get(this.brandingAndPortalUrl + "/listRecords?" + recordType + packageType + state + sort + "&start=" + start + "&rows=" + rows + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment_es6___default()().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
    ...
    DashboardService.prototype.setDashboardTitle = function (planTable, plans) {
        ...
        __WEBPACK_IMPORTED_MODULE_8_lodash__["forEach"](planTable ? planTable.items : plans, function (plan) {
            plan.dashboardTitle = (__WEBPACK_IMPORTED_MODULE_8_lodash__["isUndefined"](plan.title) || __WEBPACK_IMPORTED_MODULE_8_lodash__["isEmpty"](plan.title) || __WEBPACK_IMPORTED_MODULE_8_lodash__["isEmpty"](plan.title[0])) ? _this.translator.t('plan-with-no-title') : plan.title;
        });
    };
    DashboardService.prototype.searchRecords = function (pageNumber, basicSearch, facets) {
        ...
        var start = (pageNumber - 1) * rows;
        return this.http.get(this.brandingAndPortalUrl + "/searchPlans?start=" + start + "&rows=" + rows + "&query=" + basicSearch + "&facets=" + facets + "&ts=" + __WEBPACK_IMPORTED_MODULE_4_moment_es6___default()().unix(), this.options)
            .toPromise()
            .then(function (res) { return _this.formatDates(_this.extractData(res)); });
    };
...
var DmpFieldComponent = /** @class */ (function () {
    ...
    DmpFieldComponent.prototype.isDisabled = function () {
        ...
        if (disabledExpression != null) {
            ...
            __WEBPACK_IMPORTED_MODULE_3_lodash__["forOwn"](this.fieldMap._rootComp, function (val, key) {
                variables.imports[key] = val;
            });
            variables.imports['moment'] = __WEBPACK_IMPORTED_MODULE_4_moment_es6___default.a;
            var compiled = __WEBPACK_IMPORTED_MODULE_3_lodash__["template"](disabledExpression, variables);
            ...
            if (compiled() == "true") {
                ...
                if (this.disabled) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.disabledElements, function (disabledElement) {
                        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isFunction"](disabledElement.prop)) {
...
var ANDSVocabField = /** @class */ (function (_super) {
    ...
    ANDSVocabField.prototype.setSelected = function (item, flag) {
        ...
        if (flag) {
            ...
            __WEBPACK_IMPORTED_MODULE_5_lodash__["remove"](curVal, function (entry) {
...
var ANDSVocabComponent = /** @class */ (function (_super) {
    ...
    function ANDSVocabComponent(elementRef) {
        ...
        _this.nodeEventSubject = new __WEBPACK_IMPORTED_MODULE_7_rxjs_Subject__["b" /* Subject */]();
        ...
        if (this.field.editMode) {
            ...
            if (this.loadState == this.STATUS_INIT) {
                ...
                jQuery(this.elementRef.nativeElement).on('top.vocab.ands', function (event, data) {
                    if (__WEBPACK_IMPORTED_MODULE_5_lodash__["isEmpty"](that_1.treeData)) {
    ...
    ANDSVocabComponent.prototype.startTreeInit = function () {
        ...
        this.treeInitListener = __WEBPACK_IMPORTED_MODULE_6_rxjs_Observable__["a" /* Observable */].interval(1000).subscribe(function () {
            if (!__WEBPACK_IMPORTED_MODULE_5_lodash__["isEmpty"](_this.expandNodeIds)) {
                _this.expandNodes();
            }
            else if (!__WEBPACK_IMPORTED_MODULE_5_lodash__["isEmpty"](_this.andsTree.treeModel.getVisibleRoots()) && _this.loadState == _this.STATUS_LOADED) {
    ...
    ANDSVocabComponent.prototype.updateTreeView = function (that) {
        ...
        that.expandNodeIds = [];
        __WEBPACK_IMPORTED_MODULE_5_lodash__["each"](that.field.value, function (val) {
            _this.setNodeSelected(state, val.notation, true);
            __WEBPACK_IMPORTED_MODULE_5_lodash__["each"](val.geneaology, function (parentId) {
                if (!__WEBPACK_IMPORTED_MODULE_5_lodash__["includes"](that.expandNodeIds, parentId)) {
        ...
        that.expandNodeIds = __WEBPACK_IMPORTED_MODULE_5_lodash__["sortBy"](that.expandNodeIds, function (o) { return __WEBPACK_IMPORTED_MODULE_5_lodash__["isString"](o) ? o.length : 0; });
    };
    ANDSVocabComponent.prototype.expandNodes = function () {
        if (!__WEBPACK_IMPORTED_MODULE_5_lodash__["isEmpty"](this.expandNodeIds)) {
            var parentId_1 = this.expandNodeIds[0];
            var node = this.andsTree.treeModel.getNodeById(parentId_1);
            if (node) {
                node.expand();
                __WEBPACK_IMPORTED_MODULE_5_lodash__["remove"](this.expandNodeIds, function (id) { return id == parentId_1; });
            }
        }
    };
    ...
    ANDSVocabComponent.prototype.setNodeSelected = function (state, nodeId, flag) {
        if (flag) {
            ...
            __WEBPACK_IMPORTED_MODULE_5_lodash__["unset"](state.selectedLeafNodeIds, nodeId);
        }
    };
    ...
    ANDSVocabComponent.prototype.mapItemsToChildren = function (items) {
        return __WEBPACK_IMPORTED_MODULE_5_lodash__["map"](items, function (item) {
    ...
    ANDSVocabComponent.prototype.setParentTree = function (val, childNode) {
        var parentNotation = __WEBPACK_IMPORTED_MODULE_5_lodash__["get"](childNode, 'parent.data.notation');
        if (!__WEBPACK_IMPORTED_MODULE_5_lodash__["isUndefined"](parentNotation)) {
            if (__WEBPACK_IMPORTED_MODULE_5_lodash__["isUndefined"](val['geneaology'])) {
                val['geneaology'] = [];
            }
        ...
        else if (!__WEBPACK_IMPORTED_MODULE_5_lodash__["isUndefined"](val['geneaology'])) {
            val['geneaology'] = __WEBPACK_IMPORTED_MODULE_5_lodash__["sortBy"](val['geneaology']);
        }
    };
...
var AsynchComponent = /** @class */ (function (_super) {
    ...
    AsynchComponent.prototype.ngOnInit = function () {
        ...
        var that = this;
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isNull"](oid) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](oid) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](oid)) {
    ...
    AsynchComponent.prototype.startListen = function () {
        var _this = this;
        if (!this.isListening && (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](this.field.relatedRecordId) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.field.relatedRecordId))) {
            ...
            this.field.RecordsService.getAsyncProgress(fq).then(function (progressArr) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](progressArr, function (progress) {
    ...
    AsynchComponent.prototype.updateProgress = function (progress) {
        var targetProgress = __WEBPACK_IMPORTED_MODULE_4_lodash__["find"](this.field.progressArr, function (prog) { return prog.id == progress.id; });
        __WEBPACK_IMPORTED_MODULE_4_lodash__["assign"](targetProgress, progress);
        this.changeRef.detectChanges();
    };
...
var FieldBase = /** @class */ (function () {
    ...
    FieldBase.prototype.setOptions = function (options) {
        ...
        if (options.selectFor && options.defaultSelect) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](options.help)) {
                var newHelp = __WEBPACK_IMPORTED_MODULE_4_lodash__["defaultTo"](__WEBPACK_IMPORTED_MODULE_4_lodash__["find"](options.help, function (f) { return f.key === options.selectFor; }), __WEBPACK_IMPORTED_MODULE_4_lodash__["find"](options.help, function (f) { return f.key === options.defaultSelect; }));
        ...
        this.editMode = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options.editMode) ? false : options.editMode;
        this.readOnly = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options.readOnly) ? false : options.readOnly;
        this.onChange = options['onChange'] || null;
        this.publish = options['publish'] || null;
        this.subscribe = options['subscribe'] || null;
        this.visible = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['visible']) ? true : options['visible'];
        ...
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](options['validationMessages'] || {}, function (messageKey, messageName) {
        ...
        if ((__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](this.value) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.value)) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](this.defaultValue)) {
            this.value = this.defaultValue;
        }
    };
    FieldBase.prototype.getTranslated = function (key, defValue) {
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](key) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](key)) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](key.startsWith) && key.startsWith('@') && this.translationService) {
    ...
    FieldBase.prototype.createFormModel = function (valueElem) {
        ...
        if (this.required) {
            this.validators = __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required;
        }
    ...
    FieldBase.prototype.getGroup = function (group, fieldMap) {
        ...
        var retval = null;
        __WEBPACK_IMPORTED_MODULE_4_lodash__["set"](fieldMap, this.getFullFieldName() + ".field", this);
        var control = this.createFormModel();
        __WEBPACK_IMPORTED_MODULE_4_lodash__["set"](fieldMap, this.getFullFieldName() + ".control", control);
    ...
    FieldBase.prototype.valueNotNull = function (data) {
        return !__WEBPACK_IMPORTED_MODULE_4_lodash__["isNull"](data) && (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](data) ? (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isNull"](data[0])) : true);
    };
    FieldBase.prototype.setupEventHandlers = function () {
        var _this = this;
        var publishConfig = this.publish;
        var subscribeConfig = this.subscribe;
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.formModel)) {
            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](publishConfig)) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](publishConfig, function (eventConfig, eventName) {
                    ...
                    if (!eventSource) {
                        ...
                        if (!eventSource) {
                            ...
                            _this[eventSource] = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
                        }
                    }
                    eventSource.subscribe(function (value) {
                        if (_this.valueNotNull(value)) {
                            var emitData_1 = value;
                            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](eventConfig.fields)) {
                                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](value)) {
                                    emitData_1 = [];
                                    __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](value, function (v) {
                                        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](v)) {
                                            var item_1 = {};
                                            __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](eventConfig.fields, function (f) {
                                                __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](f, function (src, tgt) {
                                                    item_1[tgt] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](v, src);
                                                });
                                            });
                                    ...
                                    emitData_1 = {};
                                    if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](value)) {
                                        __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](eventConfig.fields, function (f) {
                                            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](f, function (src, tgt) {
                                                emitData_1[tgt] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](value, src);
                                            });
                                        });
                                    }
                                }
        ...
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](subscribeConfig)) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](subscribeConfig, function (subConfig, srcName) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](subConfig, function (eventConfArr, eventName) {
                    ...
                    eventEmitter.subscribe(function (value) {
                        ...
                        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](value)) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](value, function (v) {
                                var entryVal = v;
                                __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](eventConfArr, function (eventConf) {
                                    var fn = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](_this, eventConf.action);
                                    if (fn) {
                                ...
                                if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](entryVal)) {
                        ...
                        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](curValue)) {
    ...
    FieldBase.prototype.getEventEmitter = function (eventName, srcName) {
        if (srcName == "this") {
            return __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this, eventName);
        }
        if (srcName == "form") {
            return __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.fieldMap['_rootComp'], eventName);
        }
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.fieldMap[srcName].field, eventName);
    };
    ...
    FieldBase.prototype.reactEvent = function (eventName, eventData, origData) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](this.componentReactors, function (compReact) {
    ...
    FieldBase.prototype.setFieldMapEntry = function (fieldMap, fieldCompRef) {
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](this.name) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.name) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isNull"](this.name)) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["set"](fieldMap, this.getFullFieldName() + ".instance", fieldCompRef.instance);
        }
    };
    ...
    FieldBase.prototype.getControl = function (name, fieldMap) {
        ...
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](fieldMap ? fieldMap : this.fieldMap, this.getFullFieldName(name) + ".control");
    };
    ...
    FieldBase.prototype.setVisibility = function (data) {
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isObject"](this.visibilityCriteria) && this.visibilityCriteria.type == 'function') {
            var fn = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this, this.visibilityCriteria.action);
            if (fn) {
                var boundFunction = fn;
            ...
            this.visible = __WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](data, this.visibilityCriteria);
        }
    };
    FieldBase.prototype.replaceValWithConfig = function (val) {
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](this.appConfig, function (configVal, configKey) {
            val = val.replace(new RegExp("@" + configKey, 'g'), configVal);
        });
        return val;
    };
    FieldBase.prototype.getConfigEntry = function (name, defValue) {
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](__WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.appConfig, name)) ? defValue : __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](this.appConfig, name);
    };
    ...
    FieldBase.prototype.setRequiredAndClearValueOnFalse = function (flag) {
        ...
        if (flag) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](this.validators) && __WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](this.validators, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required)) {
                this.validators = null;
            }
        ...
        if (flag) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](this.validators) && __WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](this.validators, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required)) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_lodash__["remove"](this.validators, function (v) {
                    return __WEBPACK_IMPORTED_MODULE_4_lodash__["isEqual"](v, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["h" /* Validators */].required);
                });
            }
        }
        if (this.validators) {
    ...
    FieldBase.prototype.setRequiredIfDependenciesHaveValue = function (data) {
        var _this = this;
        var retVal = false;
        __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](this.requiredIfHasValue, function (name) {
            var depVal = _this.fieldMap._rootComp.getFieldValue(name);
            var hasVal = false;
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArrayLike"](depVal)) {
                hasVal = !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](depVal);
            }
            else {
                hasVal = !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](depVal) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isNull"](depVal);
            }
...
var ContributorField = /** @class */ (function (_super) {
    ...
    function ContributorField(options, injector) {
        ...
        var textFullNameFieldName = __WEBPACK_IMPORTED_MODULE_4_lodash__["find"](_this.fieldNames, function (fieldNameObject) {
        ...
        _this.validators = {
            text_full_name: [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required],
            email: [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].email]
        };
        if (!_this.freeText) {
        ...
        if (_this.splitNames) {
            ...
            _this.validators['family_name'] = [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required];
            _this.validators['given_name'] = [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required];
        }
        // Resolves: #605
        // now that we've set the default validators... we read the config to override
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](_this.activeValidators)) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](_this.activeValidators, function (vConfig, fName) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](vConfig)) {
                    _this.validators[fName] = __WEBPACK_IMPORTED_MODULE_4_lodash__["map"](vConfig, function (vConfigEntry) {
                        return __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */], vConfigEntry);
                    });
                }
                else if (vConfig == null) {
                    // remove the default...
                    __WEBPACK_IMPORTED_MODULE_4_lodash__["unset"](_this.validators, fName);
                }
            });
        }
    ...
    ContributorField.prototype.createFormModel = function (valueElem) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.value.role)) {
        ...
        if (this.required) {
            ...
            if (this.splitNames) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](reqFields, function (reqField) {
                    _this.formModel.controls[reqField].valueChanges.subscribe(handler_1);
                });
                // install the validators if needed
                var hasValue = !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.value.family_name) || !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.value.given_name);
                this.toggleConditionalValidation(hasValue);
            }
            else {
                // install the validators if needed
                this.toggleConditionalValidation(!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.value.text_full_name));
            }
        }
        return this.formModel;
    };
    ContributorField.prototype.getToggleConditionalValidationHandler = function (requiredFields, useFormControl) {
        ...
        return (function (value) {
            var hasValue = true;
            if (useFormControl) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](requiredFields, function (reqField) {
                    hasValue = hasValue || !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](_this.formModel.controls[reqField].value);
                });
            }
            else {
                hasValue = !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](value);
            }
    ...
    ContributorField.prototype.setValue = function (value, emitEvent, updateTitle) {
        ...
        if (!this.hasInit) {
            this.hasInit = true;
            value.username = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](value.username) ? '' : value.username;
        }
        else {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](value.username) || (value.email && value.email != this.previousEmail)) {
                value.username = '';
        ...
        // install the validators if needed
        if (this.splitNames) {
            var hasValue = !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](value.family_name) || !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](value.given_name);
            this.toggleConditionalValidation(hasValue);
        }
        else {
            this.toggleConditionalValidation(!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](value.text_full_name));
        }
    };
    ContributorField.prototype.toggleConditionalValidation = function (hasValue) {
        ...
        if (hasValue) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](this.activeValidators, function (vConfig, fName) {
                if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](_this.validators[fName])) {
    ...
    ContributorField.prototype.toggleValidator = function (c) {
        var _this = this;
        return function (value) {
            if (value || __WEBPACK_IMPORTED_MODULE_4_lodash__["find"](_this.formModel.controls, function (c) { return c.value; })) {
    ...
    ContributorField.prototype.enableValidators = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.groupFieldNames, function (f) {
            // Resolves #605: check if there is a validator, because we can disable/remove validators now
            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](_this.validators[f])) {
    ...
    ContributorField.prototype.disableValidators = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.formModel.controls, function (c) {
    ...
    ContributorField.prototype.postInit = function (value) {
        if (value) {
            ...
            if (!this.freeText) {
                ...
                this.vocabField.initialValue = __WEBPACK_IMPORTED_MODULE_4_lodash__["cloneDeep"](value);
            ...
            if (this.findRelationship && __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.vocabField.initialValue.title)) {
    ...
    ContributorField.prototype.initWithRelationship = function () {
        ...
        this.vocabField.relationshipLookup(relatedWith, searchFieldLower, searchField)
            ...
            if (res && res['status'] === 200) {
                var data = res.json();
                if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](data) && !data['error']) {
                    var obj = __WEBPACK_IMPORTED_MODULE_4_lodash__["first"](data);
                    if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](obj[relationship])) {
                        rel = __WEBPACK_IMPORTED_MODULE_4_lodash__["first"](obj[relationship]);
                    }
                }
            }
            if (rel) {
                ...
                return __WEBPACK_IMPORTED_MODULE_6_rxjs_Rx__["a" /* Observable */].of(null);
            }
        })
            .subscribe(function (res) {
            if (res && res['status'] === 200) {
    ...
    ContributorField.prototype.getFirstOrDefault = function (obj, defaultValue) {
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["defaultTo"](__WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](obj) ? __WEBPACK_IMPORTED_MODULE_4_lodash__["first"](obj) : obj, defaultValue);
    };
    ContributorField.prototype.setEmptyValue = function (emitEvent) {
        if (emitEvent === void 0) { emitEvent = true; }
        this.value = { text_full_name: null, email: null, role: null, username: '' };
        if (this.formModel) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](this.formModel.controls, function (c, cName) {
    ...
    ContributorField.prototype.getValidationError = function () {
        ...
        if (this.formModel) {
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.groupFieldNames, function (f) {
                if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](_this.formModel.controls[f].errors)) {
    ...
    ContributorField.prototype.setMissingFields = function (value) {
        if (this.splitNames && (value && value.text_full_name && (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](value.family_name) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](value.family_name)))) {
            // guess work begins...
    ...
    ContributorField.prototype.reactEvent = function (eventName, eventData, origData) {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.componentReactors)) {
...
var ContributorComponent = /** @class */ (function (_super) {
    ...
    ContributorComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.field.editMode && this.ngCompleter) {
            ...
            this.ngCompleter.registerOnChange(function (v) {
                that_1.emptied = __WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](v);
    ...
    ContributorComponent.prototype.onSelect = function (selected, emitEvent, updateTitle) {
        ...
        if (updateTitle === void 0) { updateTitle = false; }
        if (selected) {
            if ((__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](selected.title) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](selected.title)) && (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](selected.text_full_name) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](selected.text_full_name))) {
            ...
            if (!this.field.freeText) {
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](selected.text_full_name)) {
                ...
                if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](selected.orcid) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](selected.orcid)) {
                    val['orcid'] = selected.orcid;
                }
                if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](selected.username) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](selected.username)) {
    ...
    ContributorComponent.prototype.onKeyUp = function (event) {
        ...
        this.field.toggleConditionalValidation(!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](val));
    };
...
var FieldControlMetaService = /** @class */ (function (_super) {
    ...
    FieldControlMetaService.prototype.getFieldsMeta = function (fieldsArr) {
        var _this = this;
        var fields = __WEBPACK_IMPORTED_MODULE_2_lodash__["map"](fieldsArr, function (f) {
            // console.log(f.class);
            ...
            if (__WEBPACK_IMPORTED_MODULE_2_lodash__["isArray"](_this.classes[f.class].comp)) {
                inst.compClass = __WEBPACK_IMPORTED_MODULE_2_lodash__["find"](_this.classes[f.class].comp, function (c) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_2_lodash__["isUndefined"](inst.compClass)) {
    ...
    FieldControlMetaService.prototype.flattenFields = function (fields, fieldArr) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_2_lodash__["map"](fields, function (f) {
            fieldArr.push(f);
            if (f.fields) {
...
var DataLocationField = /** @class */ (function (_super) {
    ...
    function DataLocationField(options, injector) {
        ...
        _this.locationAddText = _this.getTranslated(options['locationAddText'], null);
    ...
    DataLocationField.prototype.clearPendingAtt = function (value) {
        __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](value, function (val) {
            if (val.type == 'attachment') {
                __WEBPACK_IMPORTED_MODULE_3_lodash__["unset"](val, 'pending');
            }
        });
    };
    DataLocationField.prototype.removeLocation = function (loc) {
        __WEBPACK_IMPORTED_MODULE_3_lodash__["remove"](this.value, function (val) {
...
var DataLocationComponent = /** @class */ (function (_super) {
    ...
    DataLocationComponent.prototype.ngOnInit = function () {
        ...
        if (this.field.editMode) {
            if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isNull"](oid) || __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](oid) || __WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](oid)) {
                // wait for the OID to be set when record is created
                if (!this.field.fieldMap._rootComp.getSubscription('recordCreated')) {
                    console.log("Subscribing to record creation..... " + this.field.name);
    ...
    DataLocationComponent.prototype.tempClearPending = function () {
        ...
        var fieldVal = __WEBPACK_IMPORTED_MODULE_3_lodash__["cloneDeep"](this.field.fieldMap._rootComp.form.value[this.field.name]);
    ...
    DataLocationComponent.prototype.isAttachmentsDisabled = function () {
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.oid)) {
...
var MapField = /** @class */ (function (_super) {
    ...
    function MapField(options, injector) {
        ...
        */
        ...
        _this.leafletOptions = __WEBPACK_IMPORTED_MODULE_4_lodash__["merge"](_this.leafletOptions, _this.masterLeafletOptions);
        _this.drawOptions = options['drawOptions'] || _this.drawOptions;
        // merge in master options to ensure we have the right layers configured
        _this.drawOptions = __WEBPACK_IMPORTED_MODULE_4_lodash__["merge"](_this.drawOptions, _this.masterDrawOptions);
    ...
    MapField.prototype.registerMapEventHandlers = function (map) {
        ...
        map.on('draw:edited', function (e) {
            ...
            layers.eachLayer(function (layer) {
                var layerIndex = __WEBPACK_IMPORTED_MODULE_4_lodash__["findIndex"](that2.layers, function (o) { return o._leaflet_id == layer._leaflet_id; });
                if (layerIndex == -1) {
        ...
        map.on('draw:deleted', function (e) {
            ...
            var that2 = that;
            layers.eachLayer(function (layer) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["remove"](that2.layers, function (o) { return o._leaflet_id == layer._leaflet_id; });
            });
        });
    };
    ...
    PDFListComponent.prototype.ngOnInit = function () {
        ...
        if (oid) {
            ...
            allAttachmentsPromise.then(function (allAttachments) {
                ...
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](allAttachments, function (attachment) {
                    if (matchingExpression_1.test(attachment.label)) {
                        ...
                        if (_this.field.latestPdf == null || __WEBPACK_IMPORTED_MODULE_6_moment_es6___default()(_this.field.latestPdf['dateUpdated']).isBefore(__WEBPACK_IMPORTED_MODULE_6_moment_es6___default()(attachment.dateUpdated))) {
...
var PublishDataLocationSelectorComponent = /** @class */ (function (_super) {
    ...
    PublishDataLocationSelectorComponent.prototype.selectAllLocations = function (checked) {
        __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.field.value, function (dataLocation) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__records_service__ = __webpack_require__("./redbox-portal/angular/shared/form/records.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_Observable__ = __webpack_require__("./node_modules/rxjs/_esm5/Observable.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_observable_zip__ = __webpack_require__("./node_modules/rxjs/_esm5/add/observable/zip.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_observable_fromPromise__ = __webpack_require__("./node_modules/rxjs/_esm5/observable/fromPromise.js");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var RelatedObjectDataField = /** @class */ (function (_super) {
    ...
    */
    RelatedObjectDataField.prototype.asyncLoadData = function () {
        ...
        var that = this;
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.value, function (item) {
            getRecordMetaObs.push(Object(__WEBPACK_IMPORTED_MODULE_8_rxjs_observable_fromPromise__["a" /* fromPromise */])(_this.recordsService.getRecordMeta(item.id)).flatMap(function (meta) {
                if (!meta) {
        ...
        if (getRecordMetaObs.length > 0) {
            return __WEBPACK_IMPORTED_MODULE_6_rxjs_Observable__["a" /* Observable */].zip.apply(__WEBPACK_IMPORTED_MODULE_6_rxjs_Observable__["a" /* Observable */], getRecordMetaObs);
        }
        else {
            return __WEBPACK_IMPORTED_MODULE_6_rxjs_Observable__["a" /* Observable */].of(null);
        }
...
var RelatedObjectSelectorField = /** @class */ (function (_super) {
    ...
    function RelatedObjectSelectorField(options, injector) {
        ...
        _this.resetSelectorEvent = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    ...
    RelatedObjectSelectorField.prototype.onFilterChange = function () {
        var _this = this;
        this.filteredPlans = __WEBPACK_IMPORTED_MODULE_4_lodash__["filter"](this.plans.items, function (plan) {
            plan.selected = false;
            var title = __WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](plan.title) ? plan.title[0] : plan.title;
            return __WEBPACK_IMPORTED_MODULE_4_lodash__["toLower"](title).includes(__WEBPACK_IMPORTED_MODULE_4_lodash__["toLower"](_this.searchFilterName));
        });
    };
...
var RelatedObjectSelectorComponent = /** @class */ (function (_super) {
    ...
    RelatedObjectSelectorComponent.prototype.hasFilteredResults = function () {
        return this.field.searchFilterName && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](__WEBPACK_IMPORTED_MODULE_4_lodash__["trim"](this.field.searchFilterName)) && this.field.filteredPlans && this.field.filteredPlans.length > 0;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
...
var RepeatableContainer = /** @class */ (function (_super) {
    ...
    function RepeatableContainer(options, injector) {
        ...
        _this.delegateErrorHandling = !__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['delegateErrorHandling']) ? options['delegateErrorHandling'] : true;
        return _this;
    }
    ...
    RepeatableContainer.prototype.getGroup = function (group, fieldMap) {
        ...
        if (!this.value || this.value.length == 0) {
            this.formModel = this.required ? new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormArray */](this.getInitArrayEntry(), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required) : new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormArray */](this.getInitArrayEntry());
        }
        else {
            var fieldCtr_1 = 0;
            var baseField_1 = this.fields[0];
            var elems_1 = [];
            this.fields = __WEBPACK_IMPORTED_MODULE_4_lodash__["map"](this.value, function (valueElem) {
                var fieldClone = null;
                if (fieldCtr_1 == 0) {
                    fieldClone = baseField_1;
                    fieldClone.value = __WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](valueElem) ? valueElem[fieldCtr_1] : valueElem;
                }
                else {
                    fieldClone = _this.createNewElem(baseField_1, __WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](valueElem) ? valueElem[fieldCtr_1] : valueElem);
                    fieldClone.value = __WEBPACK_IMPORTED_MODULE_4_lodash__["isArray"](valueElem) ? valueElem[fieldCtr_1] : valueElem;
                }
                fieldCtr_1++;
            ...
            this.formModel = this.required ? new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormArray */](elems_1, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required) : new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormArray */](elems_1);
    ...
    RepeatableContainer.prototype.createNewElem = function (baseFieldInst, value) {
        ...
        var newOpts = __WEBPACK_IMPORTED_MODULE_4_lodash__["cloneDeep"](baseFieldInst.options);
        newOpts.value = value;
        var newInst = new baseFieldInst.constructor(newOpts, this.injector);
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.skipClone, function (f) {
            newInst[f] = null;
        });
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.forceClone, function (f) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](f)) {
                newInst[f] = __WEBPACK_IMPORTED_MODULE_4_lodash__["cloneDeepWith"](baseFieldInst[f], _this.getCloneCustomizer({
                ...
                newInst[f.field] = __WEBPACK_IMPORTED_MODULE_4_lodash__["cloneDeepWith"](baseFieldInst[f.field], _this.getCloneCustomizer(f));
            }
        });
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](newInst.postInit)) {
    ...
    RepeatableContainer.prototype.getCloneCustomizer = function (cloneOpts) {
        ...
        return function (value, key) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["includes"](cloneOpts.skipClone, key)) {
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["includes"](cloneOpts.copy, key)) {
                    return that[key];
                }
                return false;
            }
    ...
    RepeatableContainer.prototype.addElem = function (val) {
        ...
        if (val == null && __WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](newElem.setEmptyValue)) {
    ...
    RepeatableContainer.prototype.removeElem = function (index) {
        __WEBPACK_IMPORTED_MODULE_4_lodash__["remove"](this.fields, function (val, idx) { return idx == index; });
    ...
    RepeatableContainer.prototype.triggerValidation = function () {
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.fields, function (f) {
            f.triggerValidation();
        });
    };
    RepeatableContainer.prototype.reactEvent = function (eventName, eventData, origData) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](eventData, function (entry, idx) {
    ...
    RepeatableContainer.prototype.removeAllElems = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](this.fields, function (f, idx) {
...
var RepeatableComponent = /** @class */ (function (_super) {
    ...
    RepeatableComponent.prototype.hasRequiredError = function () {
        var hasError = false;
        __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](this.field.formModel.controls, function (c) {
...
var RepeatableContributor = /** @class */ (function (_super) {
    ...
    function RepeatableContributor(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.canSort = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['canSort']) ? false : options['canSort'];
        return _this;
    }
...
var SimpleComponent = /** @class */ (function () {
    ...
    SimpleComponent.prototype.getFormControl = function (name, ctrlIndex) {
        ...
        var fc = null;
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](name)) {
            name = this.name;
        }
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](name)) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isNull"](ctrlIndex) && !__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](ctrlIndex)) {
            if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isNull"](fc.controls) && !__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](fc.controls)) {
        ...
        if (name != this.field.name && !__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.field.name) && !__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](fc.controls)) {
...
var SelectionComponent = /** @class */ (function (_super) {
    ...
    SelectionComponent.prototype.getLabel = function (val) {
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](val)) {
            return '';
        }
        var opt = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](this.field.selectOptions, function (opt) {
...
var SelectionFieldComponent = /** @class */ (function (_super) {
    ...
    SelectionFieldComponent.prototype.isValArray = function () {
        return __WEBPACK_IMPORTED_MODULE_3_lodash__["isArray"](this.field.value);
    };
    ...
    SelectionFieldComponent.prototype.getControlFromOption = function (opt) {
        var control = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](this.getFormControl()['controls'], function (ctrl) {
    ...
    SelectionFieldComponent.prototype.onChange = function (opt, event) {
        ...
        if (event.target.checked) {
            ...
            var idx_1 = null;
            __WEBPACK_IMPORTED_MODULE_3_lodash__["forEach"](formcontrol.controls, function (ctrl, i) {
...
var TabOrAccordionContainerComponent = /** @class */ (function (_super) {
    ...
    TabOrAccordionContainerComponent.prototype.ngAfterViewInit = function () {
        var that = this;
        __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.field.fields, function (tab) {
            tab['expandedChar'] = '+';
...
var TabNavButtonComponent = /** @class */ (function (_super) {
    ...
    TabNavButtonComponent.prototype.ngAfterViewInit = function () {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](focusTabId)) {
...
var LinkValueComponent = /** @class */ (function (_super) {
    ...
    LinkValueComponent.prototype.isVisible = function () {
        return !__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](this.field.value);
    };
...
var HiddenValueComponent = /** @class */ (function (_super) {
    ...
    HiddenValueComponent.prototype.handleChange = function (value, source) {
        ...
        console.log(value);
        var targetVal = null;
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isArray"](value)) {
            targetVal = [];
            __WEBPACK_IMPORTED_MODULE_3_lodash__["forEach"](value, function (v) {
                var tVal = '';
                __WEBPACK_IMPORTED_MODULE_3_lodash__["forEach"](_this.field.onChange.control.subFields, function (subField) {
                    tVal = "" + (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](tVal) ? tVal : "" + tVal + _this.field.onChange.control.delim) + v[subField];
                });
                targetVal.push(tVal);
            });
        }
...
var SelectionField = /** @class */ (function (_super) {
    ...
    function SelectionField(options, injector) {
        ...
        if (options.selectFor && options.defaultSelect) {
            var newOptions = __WEBPACK_IMPORTED_MODULE_3_lodash__["defaultTo"](__WEBPACK_IMPORTED_MODULE_3_lodash__["find"](options['options'], function (f) { return f.key === options.selectFor; }), __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](options['options'], function (f) { return f.key === options.defaultSelect; }));
            options['options'] = newOptions.value;
        }
        _this.selectOptions = __WEBPACK_IMPORTED_MODULE_3_lodash__["map"](options['options'] || [], function (option) {
        ...
        if (options['storeValueAndLabel']) {
            ...
            if (options['value'] == undefined) {
                var emptyOptions = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](_this.selectOptions, function (selectOption) {
    ...
    SelectionField.prototype.createFormModel = function () {
        ...
        if (this.controlType == 'checkbox') {
            var fgDef_1 = [];
            __WEBPACK_IMPORTED_MODULE_3_lodash__["map"](this.selectOptions, function (opt) {
                var hasValue = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](_this.value, function (val) {
    ...
    SelectionField.prototype.nextOption = function () {
        ...
        if (this.controlType == 'radio') {
            var nextIdx_1 = 0;
            var opt = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](this.selectOptions, function (opt, idx) {
...
var Container = /** @class */ (function (_super) {
    ...
    function Container(options, injector) {
        ...
        _this.isGroup = true;
        _this.hasControl = __WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](_this.groupName);
        if (__WEBPACK_IMPORTED_MODULE_3_lodash__["isEmpty"](_this.cssClasses) && __WEBPACK_IMPORTED_MODULE_3_lodash__["startsWith"](_this.type, 'h')) {
    ...
    Container.prototype.getGroup = function (group, fieldMap) {
        this.fieldMap = fieldMap;
        __WEBPACK_IMPORTED_MODULE_3_lodash__["set"](fieldMap, this.getFullFieldName() + ".field", this);
        group[this.name] = this.required ? new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({}, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required) : new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({});
    ...
    Container.prototype.createFormModel = function (valueElem) {
        ...
        __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.fields, function (field) {
            var fldVal = null;
            if (_this.value) {
                fldVal = __WEBPACK_IMPORTED_MODULE_3_lodash__["get"](_this.value, field.name);
            }
            field.value = fldVal;
            grp[field.name] = field.createFormModel(fldVal);
        });
        this.formModel = this.required ? new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */](grp, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["h" /* Validators */].required) : new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */](grp);
        return this.formModel;
    };
    Container.prototype.setValue = function (value, emitEvent) {
        ...
        if (emitEvent === void 0) { emitEvent = true; }
        this.value = value;
        __WEBPACK_IMPORTED_MODULE_3_lodash__["forOwn"](value, function (val, key) {
            var fld = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](_this.fields, function (fldItem) {
...
var TabOrAccordionContainer = /** @class */ (function (_super) {
    ...
    function TabOrAccordionContainer(options, injector) {
        ...
        _this.onAccordionCollapseExpand = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
...
var DateTime = /** @class */ (function (_super) {
    ...
    function DateTime(options, injector) {
        ...
        _this.adjustStartRange = !__WEBPACK_IMPORTED_MODULE_3_lodash__["isUndefined"](options['adjustStartRange']) ? options['adjustStartRange'] : false;
        return _this;
    }
    ...
    DateTime.prototype.reactEvent = function (eventName, eventData, origData) {
        if (this.adjustStartRange) {
            ...
            var newOpts = __WEBPACK_IMPORTED_MODULE_3_lodash__["cloneDeep"](this.datePickerOpts);
...
var TabNavButton = /** @class */ (function (_super) {
    ...
    TabNavButton.prototype.getTabs = function () {
        ...
        if (targetContainerTab) {
            __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](targetContainerTab.definition.fields, function (tab) {
    ...
    TabNavButton.prototype.getTargetTab = function (fields) {
        var _this = this;
        var targetTab = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](fields, function (f) {
    ...
    TabNavButton.prototype.getCurrentTabIdx = function () {
        var _this = this;
        return __WEBPACK_IMPORTED_MODULE_3_lodash__["findIndex"](this.tabs, function (curTab) { return curTab == _this.currentTab; });
    };
...
var TextField = /** @class */ (function (_super) {
    ...
    function TextField(options, injector) {
        ...
        _this.type = options['type'] || '';
        _this.controlType = 'textbox';
        _this.cssClasses = __WEBPACK_IMPORTED_MODULE_1_lodash__["isEmpty"](_this.cssClasses) ? 'form-control' : _this.cssClasses;
        return _this;
    }
...
var MarkdownTextArea = /** @class */ (function (_super) {
    ...
    function MarkdownTextArea(options, injector) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1_lodash__["isUndefined"](_this.value)) {
            _this.value = "";
        }
        return _this;
    }
...
/* unused harmony export MintRelationshipLookup */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__field_simple_component__ = __webpack_require__("./redbox-portal/angular/shared/form/field-simple.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__field_base__ = __webpack_require__("./redbox-portal/angular/shared/form/field-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
...
var VocabField = /** @class */ (function (_super) {
    ...
    function VocabField(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.onItemSelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        ...
        _this.restrictToSelection = __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](options['restrictToSelection']) ? false : options['restrictToSelection'];
    ...
    VocabField.prototype.createFormModel = function (valueElem, createFormGroup) {
        ...
        if (this.value) {
            if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](this.value)) {
                var init = __WEBPACK_IMPORTED_MODULE_4_lodash__["cloneDeep"](this.value);
        ...
        if (this.required) {
            this.formModel.setValidators([__WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* Validators */].required]);
        }
        return this.formModel;
    };
    ...
    VocabField.prototype.initLookupData = function () {
        ...
        if (this.sourceType == "vocab") {
            ...
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.sourceData, function (data) {
    ...
    VocabField.prototype.getTitle = function (data) {
        ...
        if (data) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](this.titleFieldDelim)) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.titleFieldArr, function (titleFld) {
                    var titleVal = data[titleFld];
                    if (titleVal) {
                        title = "" + title + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](title) ? '' : _this.titleFieldDelim) + titleVal;
                    }
                });
            }
            else {
                // expecting a delim pair array, 'prefix', 'suffix'
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.titleFieldArr, function (titleFld, idx) {
                    var delimPair = _this.titleFieldDelim[idx];
                    var titleVal = data[titleFld];
                    if (titleVal) {
                        title = "" + title + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](title) ? '' : delimPair.prefix) + titleVal + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](title) ? '' : delimPair.suffix);
                    }
                });
            }
        }
    ...
    VocabField.prototype.getValue = function (data) {
        var _this = this;
        var valObj = {};
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](data) && !__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](data)) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](data)) {
            ...
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.fieldNames, function (fldName) {
    ...
    VocabField.prototype.getFieldValuePair = function (fldName, data, valObj) {
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](fldName)) {
            valObj[fldName] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, fldName);
        }
        else {
            // expects a value pair
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](fldName, function (srcFld, targetFld) {
                if (__WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, srcFld)) {
                    valObj[targetFld] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, srcFld);
                }
                else {
                    valObj[targetFld] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, targetFld);
                }
            });
        }
    };
...
var ExternalLookupDataService = /** @class */ (function (_super) {
    ...
    ExternalLookupDataService.prototype.search = function (term) {
        ...
        this.http.post(this.url, { options: { query: term } }).map(function (res, index) {
            ...
            var data = res.json();
            var itemArray = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, _this.arrayProperty);
            var matches = [];
            __WEBPACK_IMPORTED_MODULE_4_lodash__["each"](itemArray, function (item) {
    ...
    ExternalLookupDataService.prototype.getTitle = function (data) {
        ...
        if (data) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](this.titleFieldDelim)) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.titleFieldArr, function (titleFld) {
                    var titleVal = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, titleFld);
                    if (titleVal) {
                        title = "" + title + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](title) ? '' : _this.titleFieldDelim) + titleVal;
                    }
                });
...
}(__WEBPACK_IMPORTED_MODULE_6_rxjs_Subject__["b" /* Subject */]));
var MintLookupDataService = /** @class */ (function (_super) {
    __extends(MintLookupDataService, _super);
    function MintLookupDataService(url, http, fields, compositeTitleName, titleFieldArr, titleFieldDelim, titleCompleterDescription, searchFieldStr) {
        var _this = _super.call(this) || this;
        _this.url = url;
        _this.http = http;
        _this.fields = fields;
    ...
    MintLookupDataService.prototype.search = function (term) {
        var _this = this;
        term = __WEBPACK_IMPORTED_MODULE_4_lodash__["trim"](__WEBPACK_IMPORTED_MODULE_13_lucene_escape_query__["escape"](term));
        var searchString = '';
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](term)) {
            term = __WEBPACK_IMPORTED_MODULE_4_lodash__["toLower"](term);
            __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.searchFields, function (searchFld) {
                searchString = "" + searchString + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](searchString) ? '' : ' OR ') + searchFld + ":" + term + "*";
            });
        }
        ...
        this.http.get("" + searchUrl).map(function (res, index) {
            // Convert the result to CompleterItem[]
            var data = res.json();
            var matches = __WEBPACK_IMPORTED_MODULE_4_lodash__["map"](data, function (mintDataItem) { return _this.convertToItem(mintDataItem); });
            _this.next(matches);
        }).subscribe();
    };
    ...
    MintLookupDataService.prototype.convertToItem = function (data) {
        ...
        var item = {};
        __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.fields, function (fieldName) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](fieldName)) {
                item[fieldName] = data[fieldName];
            }
            else {
                // expects a value pair
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forOwn"](fieldName, function (srcFld, targetFld) {
                    if (__WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, srcFld)) {
                        item[srcFld] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, srcFld);
                    }
                    else {
                        item[targetFld] = __WEBPACK_IMPORTED_MODULE_4_lodash__["get"](data, targetFld);
                    }
                });
            }
        });
    ...
    MintLookupDataService.prototype.getCompleterDescription = function (data) {
        ...
        if (data) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](fieldDesc)) {
                var ele = data[fieldDesc];
                description = __WEBPACK_IMPORTED_MODULE_4_lodash__["toString"](__WEBPACK_IMPORTED_MODULE_4_lodash__["head"](ele)) || '';
            }
        }
        return description;
    };
        ...
        if (data) {
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isString"](this.titleFieldDelim)) {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.titleFieldArr, function (titleFld) {
                    var titleVal = data[titleFld];
                    if (titleVal) {
                        title = "" + title + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](title) ? '' : _this.titleFieldDelim) + data[titleFld];
                    }
                });
            }
            else {
...
var VocabFieldComponent = /** @class */ (function (_super) {
    ...
    VocabFieldComponent.prototype.ngOnInit = function () {
        this.field.component = this;
        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.field.value) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isNull"](this.field.value) || __WEBPACK_IMPORTED_MODULE_4_lodash__["isUndefined"](this.field.value)) {
            this.loaded = true;
        }
    };
    ...
    VocabFieldComponent.prototype.getTitle = function () {
        return this.field && __WEBPACK_IMPORTED_MODULE_4_lodash__["isFunction"](this.field.getTitle) ? this.field.getTitle(this.field.value) : '';
    };
...
var MintRelationshipLookup = /** @class */ (function () {
    ...
    MintRelationshipLookup.prototype.search = function (term, lower) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](term)) {
            if (lower)
                term = __WEBPACK_IMPORTED_MODULE_4_lodash__["toLower"](term);
            if (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](this.searchFieldStr)) {
                searchString = term;
            }
            else {
                __WEBPACK_IMPORTED_MODULE_4_lodash__["forEach"](this.searchFieldStr.split(','), function (searchFld) {
                    searchString = "" + searchString + (__WEBPACK_IMPORTED_MODULE_4_lodash__["isEmpty"](searchString) ? '' : ' OR ') + searchFld + ":" + term;
                });
            }
        }
...
var RecordsService = /** @class */ (function (_super) {
    ...
    RecordsService.prototype.getForm = function (oid, recordType, editable) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](oid)) {
            oid = null;
        }
    ...
    RecordsService.prototype.getTargetStepParam = function (targetStep, delim) {
        return __WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](targetStep) ? '' : delim + "targetStep=" + targetStep;
    };
    ...
    RecordsService.prototype.search = function (params) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_6_lodash__["size"](params.activeRefiners) > 0) {
            var exactSearchNames_1 = '';
            var exactSearchValues_1 = '';
            var facetSearchNames_1 = '';
            var facetSearchValues_1 = '';
            __WEBPACK_IMPORTED_MODULE_6_lodash__["forEach"](params.activeRefiners, function (refiner) {
                switch (refiner.type) {
                    case "exact":
                        exactSearchNames_1 = "" + (__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](exactSearchNames_1) ? "&exactNames=" : exactSearchNames_1 + ",") + refiner.name;
                        exactSearchValues_1 = exactSearchValues_1 + "&exact_" + refiner.name + "=" + refiner.value;
                        break;
                    case "facet":
                        facetSearchNames_1 = "" + (__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](facetSearchNames_1) ? "&facetNames=" : facetSearchNames_1 + ",") + refiner.name;
                        if (!__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](refiner.activeValue)) {
...
var RecordSearchParams = /** @class */ (function () {
    ...
    RecordSearchParams.prototype.clear = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_6_lodash__["remove"](this.activeRefiners, function (refiner) {
            refiner.value = null;
    ...
    RecordSearchParams.prototype.getRefinerConfig = function (name) {
        return __WEBPACK_IMPORTED_MODULE_6_lodash__["find"](this.refinerConfig, function (config) {
    ...
    RecordSearchParams.prototype.setRefinerConfig = function (config) {
        ...
        __WEBPACK_IMPORTED_MODULE_6_lodash__["forEach"](this.refinerConfig, function (refinerConfig) {
    ...
    RecordSearchParams.prototype.getHttpQuery = function (searchUrl) {
        var refinerValues = '';
        __WEBPACK_IMPORTED_MODULE_6_lodash__["forEach"](this.activeRefiners, function (refiner) {
            if (refiner.type == "facet") {
                refinerValues = refinerValues + "&refiner|" + refiner.name + "=" + (__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](refiner.activeValue) ? '' : refiner.activeValue);
            }
            else {
                refinerValues = refinerValues + "&refiner|" + refiner.name + "=" + (__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](refiner.value) ? '' : refiner.value);
            }
        });
    ...
    RecordSearchParams.prototype.addActiveRefiner = function (refiner) {
        var existingRefiner = __WEBPACK_IMPORTED_MODULE_6_lodash__["find"](this.activeRefiners, function (activeRefiner) {
    ...
    RecordSearchParams.prototype.parseQueryStr = function (queryStr) {
        ...
        var refinerValues = {};
        __WEBPACK_IMPORTED_MODULE_6_lodash__["forEach"](queryStr.split('&'), function (q) {
            var qObj = q.split('=');
            if (__WEBPACK_IMPORTED_MODULE_6_lodash__["startsWith"](qObj[0], "q")) {
                _this.basicSearch = qObj[1];
            }
            if (__WEBPACK_IMPORTED_MODULE_6_lodash__["startsWith"](qObj[0], "refiner|")) {
                var refinerName = qObj[0].split('|')[1];
                refinerValues[refinerName] = qObj[1];
            }
        });
        __WEBPACK_IMPORTED_MODULE_6_lodash__["forOwn"](refinerValues, function (value, name) {
    ...
    RecordSearchParams.prototype.filterActiveRefinersWithNoData = function () {
        var removed = __WEBPACK_IMPORTED_MODULE_6_lodash__["remove"](this.activeRefiners, function (refiner) {
            var value = refiner.type == 'exact' ? refiner.value : refiner.activeValue;
            return !refiner.alwaysActive && (__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](value) || __WEBPACK_IMPORTED_MODULE_6_lodash__["isUndefined"](value));
        });
    };
    RecordSearchParams.prototype.hasActiveRefiners = function () {
        var hasActive = false;
        __WEBPACK_IMPORTED_MODULE_6_lodash__["forEach"](this.activeRefiners, function (refiner) {
            if (!hasActive && (!__WEBPACK_IMPORTED_MODULE_6_lodash__["isEmpty"](refiner.value))) {
                hasActive = true;
            }
        });
        return hasActive;
    ...
    RecordSearchParams.prototype.setFacetValues = function (facets) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_6_lodash__["forEach"](facets, function (facet) {
            var refiner = __WEBPACK_IMPORTED_MODULE_6_lodash__["find"](_this.activeRefiners, function (refinerConfig) {
...
var TreeNodeCheckboxComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_angular_tree_component__["c" /* TreeNode */])
        ...
        if (disabledExpression != null) {
            ...
            if (compiled() == "true") {
                ...
                if (jQuery(this.fieldElement.nativeElement).prop('disabled') == 'disabled') {
                    //previously disabled so lets re-enable
                    parentElement.find('input').prop("disabled", false);
                    __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.disabledElements, function (disabledElement) { return disabledElement.prop("disabled", true); });
                }
                return null;
            }
        }
...
var WorkspaceSelectorField = /** @class */ (function (_super) {
    ...
    function WorkspaceSelectorField(options, injector) {
        ...
        // this.options = options['options'] || [];
        _this.workspaceApps = __WEBPACK_IMPORTED_MODULE_3_lodash__["map"](options['defaultSelection'] || [], function (option) {
            option['label'] = _this.getTranslated(option['label'], option['label']);
            option['name'] = '';
            return option;
        });
        ...
        _this.workspaceTypeService.getWorkspaceTypes().then(function (response) {
            if (response['status']) {
                ...
                _this.workspaceApps = __WEBPACK_IMPORTED_MODULE_3_lodash__["concat"](_this.workspaceApps, response['workspaceTypes']);
            }
            else {
    ...
    WorkspaceSelectorField.prototype.loadWorkspaceDetails = function (value) {
        ...
        if (!value) {
            ...
            this.workspaceApp = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](this.workspaceApps, function (w) {
                return w['name'] == value;
            });
        }
    };
    WorkspaceSelectorField.prototype.createFormModel = function () {
        ...
        if (this.controlType == 'checkbox') {
            var fgDef_1 = [];
            __WEBPACK_IMPORTED_MODULE_3_lodash__["map"](this.options, function (opt) {
                var hasValue = __WEBPACK_IMPORTED_MODULE_3_lodash__["find"](_this.value, function (val) {
                    return val == opt.value;
                });
                if (hasValue) {
...
var WorkspaceSelectorComponent = /** @class */ (function (_super) {
    ...
    WorkspaceSelectorComponent.prototype.getLabel = function (val) {
        var opt = __WEBPACK_IMPORTED_MODULE_2_lodash__["find"](this.field.options, function (opt) {
            return opt.value == val;
        });
        if (opt) {
            return opt.label;
...
var LoadableComponent = /** @class */ (function () {
    ...
    LoadableComponent.prototype.getTranslated = function (key, defValue) {
        if (!__WEBPACK_IMPORTED_MODULE_0_lodash__["isEmpty"](key) && !__WEBPACK_IMPORTED_MODULE_0_lodash__["isUndefined"](key)) {
    ...
    LoadableComponent.prototype.waitForInit = function (serviceArr, handler) {
        var subs = __WEBPACK_IMPORTED_MODULE_0_lodash__["map"](serviceArr, function (service) { return service.getInitSubject(); });
        ...
        var subTrackerFn = function (serviceIdx) {
            return function (serviceInst) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_0_lodash__["keys"](subTracker.loaded).length >= subs.length) {
                    subTracker.subs["" + serviceIdx].unsubscribe();
                    handler();
                }
            };
        };
        __WEBPACK_IMPORTED_MODULE_0_lodash__["forOwn"](serviceArr, function (service, serviceIdx) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__form_tree_node_checkbox_component__ = __webpack_require__("./redbox-portal/angular/shared/form/tree-node-checkbox.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44_mobx_angular__ = __webpack_require__("./node_modules/mobx-angular/dist/mobx-angular.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TranslationService = /** @class */ (function () {
    ...
    TranslationService.prototype.initTranslator = function () {
        var _this = this;
        this.subjects['init'] = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["b" /* Subject */]();
        var ts = new Date().getTime();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__("./node_modules/lodash/lodash.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment_es6__ = __webpack_require__("./node_modules/moment-es6/index.js");
...
var UtilityService = /** @class */ (function () {
    ...
    UtilityService.prototype.concatenate = function (data, config) {
        var result = '';
        __WEBPACK_IMPORTED_MODULE_1_lodash__["each"](config.fields, function (f) {
            if (__WEBPACK_IMPORTED_MODULE_1_lodash__["isArray"](data)) {
                result = [];
                var itemResult_1 = '';
                __WEBPACK_IMPORTED_MODULE_1_lodash__["each"](data, function (d) {
                    var fldData = __WEBPACK_IMPORTED_MODULE_1_lodash__["get"](d, f);
                    // checking if field has data, otherwise will be skipping concat
                    if (fldData) {
                        itemResult_1 = "" + itemResult_1 + (__WEBPACK_IMPORTED_MODULE_1_lodash__["isEmpty"](itemResult_1) ? '' : config.delim) + fldData;
                    }
                });
                result.push(itemResult_1);
            }
            else {
                var fldData = __WEBPACK_IMPORTED_MODULE_1_lodash__["get"](data, f);
                if (fldData) {
                    result = "" + result + (__WEBPACK_IMPORTED_MODULE_1_lodash__["isEmpty"](result) ? '' : config.delim) + fldData;
                }
            }
        });
        return result;
    ...
    UtilityService.prototype.getPropertyFromObject = function (data, config) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1_lodash__["get"](data, fieldPath);
    };
    /**
    ...
    UtilityService.prototype.getPropertyFromObjectMapping = function (data, config) {
        var fieldPath = config.field;
        var val = __WEBPACK_IMPORTED_MODULE_1_lodash__["isUndefined"](fieldPath) ? data : __WEBPACK_IMPORTED_MODULE_1_lodash__["get"](data, fieldPath);
        var foundMapping = __WEBPACK_IMPORTED_MODULE_1_lodash__["find"](config.mapping, function (mapEntry) {
    ...
    UtilityService.prototype.hasValue = function (data, config) {
        ...
        return !__WEBPACK_IMPORTED_MODULE_1_lodash__["isEmpty"](data) && !__WEBPACK_IMPORTED_MODULE_1_lodash__["isUndefined"](data) && !__WEBPACK_IMPORTED_MODULE_1_lodash__["isNull"](data);
    };
    /**
    ...
    UtilityService.prototype.getPropertyFromObjectConcat = function (data, config) {
        var values = [];
        __WEBPACK_IMPORTED_MODULE_1_lodash__["each"](config.field, function (f) {
            values.push(__WEBPACK_IMPORTED_MODULE_1_lodash__["get"](data, f));
        });
        return __WEBPACK_IMPORTED_MODULE_1_lodash__["concat"].apply(__WEBPACK_IMPORTED_MODULE_1_lodash__, [[]].concat(values));
    };
    /**
    ...
    UtilityService.prototype.splitStringToArray = function (data, config) {
        ...
        var value = data;
        if (field) {
            value = __WEBPACK_IMPORTED_MODULE_1_lodash__["get"](data, field);
        }
    ...
    UtilityService.prototype.splitArrayStringsToArray = function (data, config) {
        ...
        var values = [];
        __WEBPACK_IMPORTED_MODULE_1_lodash__["each"](value, function (v) {
            if (v) {
    ...
    UtilityService.prototype.getFirstofArray = function (data, config) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1_lodash__["first"](value);
    };
    UtilityService.prototype.joinArray = function (data, config, fieldName, fieldSeparator) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1_lodash__["join"](__WEBPACK_IMPORTED_MODULE_1_lodash__["get"](data, fieldName ? fieldName : config.field), fieldSeparator ? fieldSeparator : config.separator);
    };
    UtilityService.prototype.runTemplate = function (data, config) {
        var imports = __WEBPACK_IMPORTED_MODULE_1_lodash__["extend"]({ data: data, config: config, moment: __WEBPACK_IMPORTED_MODULE_2_moment_es6___default.a }, this);
        var templateData = { imports: imports };
        var template = __WEBPACK_IMPORTED_MODULE_1_lodash__["template"](config.template, templateData);
        return template();
    };
...
/***/ "./src/app/components/redcap-token.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return RedcapTokenField; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RedcapTokenComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__redcap_service__ = __webpack_require__("./src/app/redcap.service.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var RedcapTokenField = /** @class */ (function (_super) {
    __extends(RedcapTokenField, _super);
    function RedcapTokenField(options, injector) {
        var _this = _super.call(this, options, injector) || this;
        _this.valid = true;
        _this.submitted = false;
        _this.errorMessage = undefined;
        _this.tokenLoaded = false;
        _this.loading = true;
        _this.location = options['location'];
        _this.columns = options['columns'] || [];
        _this.tokenLabel = options['tokenLabel'] || 'Add token';
        _this.tokenAddLabel = options['tokenAddLabel'] || 'Add token';
        _this.tokenError = true;
        _this.helpTokenLabel = options['helpTokenLabel'] || '';
        _this.helpTokenLabelList = options['helpTokenLabelList'] || [];
        _this.helpTokenImageAlt = options['helpTokenImageAlt'] || 'REDCap help token';
        _this.helpTokenImage1 = options['helpTokenImage1'] || _this.helpTokenImageAlt;
        _this.helpTokenImage2 = options['helpTokenImage2'] || _this.helpTokenImageAlt;
        _this.helpTokenImage3 = options['helpTokenImage3'] || _this.helpTokenImageAlt;
        _this.closeLabel = options['closeLabel'] || 'Close';
        _this.redcapService = _this.getFromInjector(__WEBPACK_IMPORTED_MODULE_3__redcap_service__["a" /* RedcapService */]);
        _this.linkLabel = options['linkLabel'] || 'Link to Plan';
        return _this;
        //console.log(this.columns);
    }
    RedcapTokenField.prototype.init = function () {
        this.rdmp = this.fieldMap._rootComp.rdmp;
    };
    RedcapTokenField.prototype.addToken = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.redcapService.project(this.token)];
                    case 2:
                        res = _a.sent();
                        if (res.status) {
    ...
    RedcapTokenField.prototype.linkProject = function (project) {
        return __awaiter(this, void 0, void 0, function () {
            var link, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.redcapService.link(project, this.rdmp)];
                    case 1:
                        link = _a.sent();
    ...
    return RedcapTokenField;
}(__WEBPACK_IMPORTED_MODULE_2__shared_form_field_base__["a" /* FieldBase */]));

var RedcapTokenComponent = /** @class */ (function (_super) {
    __extends(RedcapTokenComponent, _super);
    function RedcapTokenComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RedcapTokenComponent.prototype.ngOnInit = function () {
        this.field.init();
    };
    RedcapTokenComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
    ...
    ], RedcapTokenComponent);
    return RedcapTokenComponent;
...
/***/ "./src/app/redcap-form.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/redcap-form.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/redcap-form.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RedcapFormComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_loadable_component__ = __webpack_require__("./redbox-portal/angular/shared/loadable.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_form_field_control_service__ = __webpack_require__("./redbox-portal/angular/shared/form/field-control.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_translation_service__ = __webpack_require__("./redbox-portal/angular/shared/translation-service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_redcap_token_component__ = __webpack_require__("./src/app/components/redcap-token.component.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
 ...
 *
 */
var RedcapFormComponent = /** @class */ (function (_super) {
    __extends(RedcapFormComponent, _super);
    function RedcapFormComponent(elm, RecordsService, fcs, LocationService, translationService) {
        var _this = _super.call(this) || this;
    ...
    RedcapFormComponent.prototype.loginUser = function (user) {
        this.user = user;
    };
    RedcapFormComponent.prototype.registerEvents = function () {
        //this.fieldMap['ListWorkspaces'].field['setWorkspaceUser'].subscribe(this.setWorkspaceUser.bind(this));
    };
    RedcapFormComponent.prototype.loadForm = function () {
        var _this = this;
        this.fcs.addComponentClasses({
            'RedcapTokenField': { 'meta': __WEBPACK_IMPORTED_MODULE_6__components_redcap_token_component__["b" /* RedcapTokenField */], 'comp': __WEBPACK_IMPORTED_MODULE_6__components_redcap_token_component__["a" /* RedcapTokenComponent */] }
        });
     ...
     * @return {[type]}
     */
    RedcapFormComponent.prototype.rebuildForm = function () {
     ...
     * @return {[type]}
     */
    RedcapFormComponent.prototype.watchForChanges = function () {
        this.setLoading(false);
        if (this.editMode) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], RedcapFormComponent.prototype, "oid", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Boolean)
    ], RedcapFormComponent.prototype, "editMode", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], RedcapFormComponent.prototype, "recordType", void 0);
    RedcapFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            moduleId: module.i,
            selector: 'redcap-form',
            template: __webpack_require__("./src/app/redcap-form.component.html"),
            styles: [__webpack_require__("./src/app/redcap-form.component.css")],
        ...
        __param(2, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_4__shared_form_field_control_service__["a" /* FieldControlService */])),
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__shared_form_field_control_service__["a" /* FieldControlService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["c" /* Location */],
            __WEBPACK_IMPORTED_MODULE_5__shared_translation_service__["a" /* TranslationService */]])
    ], RedcapFormComponent);
    return RedcapFormComponent;
}(__WEBPACK_IMPORTED_MODULE_3__shared_loadable_component__["a" /* LoadableComponent */]));



/***/ }),

/***/ "./src/app/redcap.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RedcapModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__ = __webpack_require__("./node_modules/@angular/platform-browser/esm5/platform-browser.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_shared_module__ = __webpack_require__("./redbox-portal/angular/shared/shared.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__redcap_service__ = __webpack_require__("./src/app/redcap.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__redcap_form_component__ = __webpack_require__("./src/app/redcap-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_redcap_token_component__ = __webpack_require__("./src/app/components/redcap-token.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var RedcapModule = /** @class */ (function () {
    function RedcapModule() {
    }
    RedcapModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_5__redcap_form_component__["a" /* RedcapFormComponent */], __WEBPACK_IMPORTED_MODULE_6__components_redcap_token_component__["a" /* RedcapTokenComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["g" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__shared_shared_module__["a" /* SharedModule */]
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_4__redcap_service__["a" /* RedcapService */]
            ],
            bootstrap: [
                __WEBPACK_IMPORTED_MODULE_5__redcap_form_component__["a" /* RedcapFormComponent */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_5__redcap_form_component__["a" /* RedcapFormComponent */], __WEBPACK_IMPORTED_MODULE_6__components_redcap_token_component__["a" /* RedcapTokenComponent */]
            ]
...
/***/ "./src/app/redcap.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RedcapService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var RedcapService = /** @class */ (function (_super) {
    __extends(RedcapService, _super);
    function RedcapService(http, configService) {
        var _this = _super.call(this, http, configService) || this;
        _this.configService = configService;
        _this.recordURL = _this.brandingAndPortalUrl + '/record/view';
        _this.initSubject = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["b" /* Subject */]();
        _this.emitInit();
        return _this;
    }
    RedcapService.prototype.waitForInit = function (handler) {
        var subs = this.initSubject.subscribe(handler);
        this.emitInit();
        return subs;
    };
    RedcapService.prototype.emitInit = function () {
        if (this.brandingAndPortalUrl) {
            this.initSubject.next('');
        }
    };
    RedcapService.prototype.project = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var wsUrl, result, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wsUrl = this.brandingAndPortalUrl + '/ws/redcap/project';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.post(wsUrl, { token: token }, this.options).toPromise()];
                    case 2:
                        result = _a.sent();
    ...
    RedcapService.prototype.link = function (workspace, rdmpId) {
        return __awaiter(this, void 0, void 0, function () {
            var wsUrl, result, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wsUrl = this.brandingAndPortalUrl + '/ws/redcap/link';
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_redcap_module__ = __webpack_require__("./src/app/redcap.module.ts");
...
Object(__WEBPACK_IMPORTED_MODULE_1__angular_platform_browser_dynamic__["a" /* platformBrowserDynamic */])().bootstrapModule(__WEBPACK_IMPORTED_MODULE_2__app_redcap_module__["a" /* RedcapModule */])
