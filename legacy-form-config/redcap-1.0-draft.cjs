/**
 * Preserved ReDBox v4 REDCap form configuration.
 *
 * This file is retained as migration evidence. Runtime registration uses the
 * typed form under src/form-config.
 */
module.exports.form = {
  forms: {
    'redcap-1.0-draft': {
      ...
      fields: [
        {
          ...
          viewOnly: false,
          definition: { name: 'title', value: 'REDCap', type: 'h2' }
        },
        {
          class: 'Container',
          compClass: 'TextBlockComponent',
          viewOnly: false,
          definition: { name: 'subtitle', value: 'Workspaces', type: 'h3' }
        },
        {
